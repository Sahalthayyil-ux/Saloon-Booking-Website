...
$sel = "select * from tbl_packagebooking where packagebooking_id=".$_GET['packid'];
$res = $con->query($sel);
$data = $res->fetch_assoc();
if(isset($_POST['btn_payment']))
{
    $update = "update tbl_packagebooking set packagebooking_status=1 where packagebooking_id=".$_GET['packid'];
    if($con->query($update))
    {
        ?>
        <script>
                ...
                <div class="payment-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="credit-card" required autocomplete="off"
                            ...
                            name="txtacno" required="required">
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            ...
                            <input type="text" class="form-control" id="credit-card-exp" name="txtexpdate" 
                                ...
                                title="Enter Correct Date" minlength="5" maxlength="5" required="required">
                    ...
                    <div class="amount-display">
                        ...
                        <div class="amount-value">₹<?php echo $data['packagebooking_amount']; ?></div>
                    </div>
